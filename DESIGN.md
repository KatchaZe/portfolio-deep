...
portfolio-deep/
  ...
  tests/                     # 57 suites (run_tests.py) — see §10
  ...
  run_tests.py               # run all 57 suites
...
- `run_tests.py` runs **57 suites**; `capture.py`/`verify.py` refresh + spot-check fixtures. Highlights:
